    ...
    <tbody>
        <tr>
            ...
            ?>>
                ...
                <?php if ($winkelwagen->getAfhalingVandaag()->getBestellingId() !== null && $winkelwagen->getAfhalingVandaag()->getBevestigd() && isset($_GET["action"]) && $_GET["action"] == "expand" && isset($_GET["date"]) && $_GET["date"] == "vandaag") {
