...
<div id="bestelbonForm">
    <a class="button rechts" href="winkelen.php?action=annuleer&date=<?php echo filter_input(INPUT_GET, "date", FILTER_SANITIZE_FULL_SPECIAL_CHARS); ?>">Annuleren bestelling</a>
    <a class="button rechts" href="winkelen.php?action=wijzig&date=<?php echo filter_input(INPUT_GET, "date", FILTER_SANITIZE_FULL_SPECIAL_CHARS); ?>">Wijzig bestelling</a>
